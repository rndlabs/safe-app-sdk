import { ChainInfo as _ChainInfo } from '@rndlabs/safe-gateway-typescript-sdk'
...
export { NativeCurrency } from '@rndlabs/safe-gateway-typescript-sdk'
...
export const isObjectEIP712TypedData = (obj?: unknown): obj is EIP712TypedData => {
  return (
    typeof obj === 'object' && obj != null && 'domain' in obj && 'types' in obj && 'message' in obj
  )
}
